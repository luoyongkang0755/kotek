...
> 2026-09-13 更新：以下风险 1、2 已由 50 遍批量 E2E 定量证实
> （`docs/wall_mount_e2e_50runs/README.md`）：任务完成率 50/50，单盒焊接率
> 67%——失败 47% 为门限边缘拒焊（平衡带 15.1–22.1° vs 门 15°）、50% 为
> 外侧目标掉落墙根、3% 卡死。数据支撑的门限改进建议（15°→23°）见该报告。
